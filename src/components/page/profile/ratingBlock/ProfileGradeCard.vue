<template>
  <div :class="['grade_card_container', { active, animation, plug }]">
    ...
    <img
      class="img"
      :src="require(`@/assets/icons/grade${GRADES[grade]?.id || 1}${active ? 'Color' : 'Monochrome'}.svg`)"
    />
    ...
    <div class="rating">
      <img
        v-for="n in GRADES[grade]?.stars || 0"
        :key="n"
        :src="require(`@/assets/icons/star${active ? '' : 'Gray'}.svg`)"
      />
    </div>
    <div class="text_block">
      <div class="name_block">
        <img v-if="active" src="@/assets/icons/checkmark_round_new.svg" />
