...
export const routes = [
  ...
  { path: '/ui-new/profile/signature', component: i('/ui-new/profile/signature/index.vue'), meta: { requiresAuth: false, layout: 'EmptyLayout' } },
  { path: '/ui-new/profile/contracts', component: i('/ui-new/profile/contracts/index.vue'), meta: { requiresAuth: false, layout: 'EmptyLayout' } },
  { path: '/ui-new/profile/acts', component: i('/ui-new/profile/acts/index.vue'), meta: { requiresAuth: false, layout: 'EmptyLayout' } },
