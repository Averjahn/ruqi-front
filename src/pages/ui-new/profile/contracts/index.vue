<template>
  <div class="ui-profile-contracts">
    <!-- Mobile Header -->
    <div v-if="isMobileView" class="ui-profile-contracts__mobile-header">
      <button 
        class="ui-profile-contracts__back-button"
        @click="handleBack"
      >
        <img 
          :src="require('@/assets/icons/profile/arrow-left.svg')" 
          alt="Back" 
          class="ui-profile-contracts__back-icon"
        />
      </button>
      <h1 class="ui-profile-contracts__mobile-title">Договора с исполнителями</h1>
      <div class="ui-profile-contracts__mobile-header-spacer"></div>
    </div>
    ...
    <AppHeader 
      ...
      title="Договора с исполнителями"
      :show-documents="false"
    />

    <!-- Content -->
    <div class="ui-profile-contracts__content">
...
.ui-profile-contracts__mobile-header {
  display: none;
...
.ui-profile-contracts__back-button {
  display: flex;
  align-items: center;
...
.ui-profile-contracts__mobile-title {
...
.ui-profile-contracts__mobile-header-spacer {
  width: 32px;
  flex-shrink: 0;
}

.ui-profile-contracts__content {
  max-width: 1400px;
  margin: 0 auto;
  padding: 20px;
