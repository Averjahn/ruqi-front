  ...
  <div class="privacy_police_container basic_container_global">
    <div class="text_wrapper">
      ...
      <p>
        ...
        персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые ООО "Платформенные
        решения" (далее — Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        всей информации, которую Оператор может получить о Пользователях веб-сайта (мобильного приложения RUQI).
      </p>
      ...
      <p>
        2.3. Веб-сайт и мобильное приложение — совокупность графических и информационных материалов, а также программ
      ...
      <p>
        ...
        <a href="https://lk.ruqi.ru" target="_blank" rel="noopener noreferrer">https://lk.ruqi.ru</a> (мобильного
        приложения RUQI).
      </p>
      <p>
      ...
      <p>
        2.15. Уничтожение персональных данных — любые действия, в результате которых персональные данные уничтожаются
        безвозвратно с невозможностью дальнейшего восстановления содержания персональных данных в информационной системе
        персональных данных и/или уничтожаются материальные носители персональных данных.
      </p>
      <p>
        2.16. Исполнитель – Пользователь, являющийся физическим лицом (в том числе Самозанятым), ИП или представителем
        юридического лица, откликающийся на задания Заказчиков на веб-сайте
        <a href="https://lk.ruqi.ru" target="_blank" rel="noopener noreferrer">https://lk.ruqi.ru</a> (в мобильном
        приложении RUQI), либо использующие иные возможности веб-сайта
        <a href="https://lk.ruqi.ru" target="_blank" rel="noopener noreferrer">https://lk.ruqi.ru</a> (мобильного
        приложения RUQI), позволяющие автоматизировать взаимодействие с Заказчиками.
      </p>
      ...
      <p>
        ...
        необходимую информацию в течение 10 рабочих дней с даты получения такого запроса;
      </p>
      <p>
      ...
      <h3>6. Субъекты персональных данных, основания и цели обработки их персональных данных</h3>
      <p>6.1. Категория субъектов персональных данных: Пользователи (Заказчики и Исполнители).</p>
      <p>6.2. Цель обработки:</p>
      <p>
        — Предоставление доступа Пользователей к сервисам, информации и/или материалам, содержащимся в приложении RUQI и
        на веб-сайте <a href="https://lk.ruqi.ru" target="_blank" rel="noopener noreferrer">https://lk.ruqi.ru</a>;
      </p>
      <p>— Обеспечение соблюдения требований законодательства Российской Федерации;</p>
      <p>
        — Исполнение условий Пользовательского соглашения (размещенного на веб-сайте
        <a href="https://lk.ruqi.ru" target="_blank" rel="noopener noreferrer">https://lk.ruqi.ru</a>, либо в приложении
        RUQI);
      </p>
      <p>— Разрешение споров, сбор отзывов и выявление неисправностей;</p>
      <p>
        — Контроль, улучшение качества и содержания веб-сайта
        <a href="https://lk.ruqi.ru" target="_blank" rel="noopener noreferrer">https://lk.ruqi.ru</a> (мобильного
        приложения RUQI);
      </p>
      <p>Ведение учета количества Пользователей, аналитика.</p>
      <p>
        6.3. Основание для обработки персональных данных: п. 1 ч. 1 ст. 6 Федерального закона от 27 июля 2006 г. №
        152-ФЗ «О персональных данных». Согласие субъекта персональных данных считается полученным в момент проставления
        субъектом флажка-галочки в чекбоксе.
      </p>
      <p>6.4. Сроки обработки: до момента минования надобности.</p>
      <p>
        В силу п. 5 ч. 1 ст. 6 ФЗ «О персональных данных» Персональные данные субъекта персональных данных, полученные
        Оператором с целью исполнения договоров, заключенных с субъектам персональных данных в связи с использованием
        Сервисов Платформы, может обрабатываться без получения согласия на обработку персональных данных.
      </p>
      <h4>Объем обрабатываемых Персональных данных:</h4>
      <h4>Исполнитель:</h4>
      <ul>
      ...
      <p>
        7.1. Обработка персональных данных осуществляется Оператором в четком соответствии с Законом о персональных
        данных и настоящей Политикой в отношении обработки персональных данных.
      </p>
      <p>
        7.2. Оператор не хранит и не обрабатывает чувствительные данные пользователей (такие как медицинские,
        финансовые). Все запрашиваемые разрешения используются исключительно для заявленного функционала.
      </p>
      ...
      <p>
        ...
        <a href="mailto:ruqi.drive@gmail.com" target="_blank" rel="noopener noreferrer">ruqi.drive@gmail.com</a> с
        пометкой «Актуализация персональных данных».
      </p>
      <p>
        Срок обработки персональных данных определяется достижением целей, для которых были собраны персональные данные,
      ...
      <p>
        ...
        изменение), извлечение, использование, передачу (распространение, предоставление, доступ), блокирование,
      ...
      <p>
        ...
        полученной информации по информационно-телекоммуникационным сетям или без таковой. Оператор также может
        осуществлять неавтоматизированную, смешанную обработку персональных данных с участием своих сотрудников.
      </p>
      ...
      <p>
        ...
        персональных данных, соответствующие сведения, указанные в ст. 12 Закона о персональных данных.
      </p>
      ...
      <h3>12. Сбор файлов Cookie</h3>
      <p>
        12.1. Оператор осуществляет сбор и использование Cookie-файлов, уведомив Пользователя при первом посещении
        веб-сайта <a href="https://lk.ruqi.ru" target="_blank" rel="noopener noreferrer">https://lk.ruqi.ru</a> и
        запросив согласие.
      </p>
      <p>
        12.2. Если в будущем Пользователь решит прекратить использование файлов Cookie, Пользователь может удалить
        Cookie-файлы, хранящиеся в браузере Пользователя.
      </p>
      <p>
        12.3. Впоследствии Пользователь может снова дать разрешение на сбор и использование Cookie-файлов, дав согласие
        через уведомление на веб-сайте
        <a href="https://lk.ruqi.ru" target="_blank" rel="noopener noreferrer">https://lk.ruqi.ru</a>.
      </p>
      <h3>13. Заключительные положения</h3>
      <p>
        13.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его
        персональных данных, обратившись к Оператору с помощью электронной почты
        <a href="mailto:ruqi.drive@gmail.com" target="_blank" rel="noopener noreferrer">ruqi.drive@gmail.com</a>.
      </p>
      <p>
        13.2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором.
      ...
      <p>
        ...
        <a href="https://lk.ruqi.ru/privacy-policy" target="_blank" rel="noopener noreferrer"
          >https://lk.ruqi.ru/privacy-policy</a
        >.
      </p>

      <h3>14. Реквизиты Компании</h3>
      <p>ООО "ПЛАТФОРМЕННЫЕ РЕШЕНИЯ"</p>
      <p>ИНН: 7733440492</p>
      <p>КПП: 773301001</p>
      <p>ОГРН: 1247700196094</p>
      <p>ОКПО: 98506530</p>
      <!-- <p>Расчетный счет: 40702810725610001343</p> -->
      <!-- <p>Банк: Филиал "Центральный" Банка ВТБ (ПАО)</p>
      <p>БИК: 044525411</p>
      <p>Корр. счет: 30101810145250000411</p> -->
      <p>
        Юридический адрес: 125371, Город Москва, вн.тер. г. Муниципальный Округ Покровское-Стрешнево, ш Волоколамское,
        дом 116, помещение 439
      </p>
      <p>Телефон: +7(936)287-64-68</p>
      <p>Электронная почта: platformennyye.resheniya@mail.ru</p>
      <p>Генеральный Директор: Логунова Алина Юрьевна</p>
    </div>
  </div>
</template>
